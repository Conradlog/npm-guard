...
<div class="container">
  ...
  <p class="subtitle">Generated on ${new Date().toLocaleString("en-US")}</p>
  ...
  <div class="package package-danger">
    ...
    <div class="finding">
      ...
      if (f.isSafe) {
        html += `<div class="match"><span class="match-badge" style="background:#22c55e">SAFE</span> Recognized build tool</div>`;
      }
  ...
  <div class="package package-safe">
    <div class="pkg-header"><span class="pkg-name">Safe packages</span></div>
    <div class="safe-list">`;
    for (const r of safe) {
  ...
  html += `
  <footer>Report generated by npm-guard &mdash; https://github.com/Conradlog/npm-guard</footer>
</div>
</body>
</html>`;
